    ...
    <section class="relative z-20 -mt-10 px-4 mb-5">
        ...
        <div class="shadow-lg p-6 max-w-2xl mx-auto text-center bg-royal-blue">
            <div class="flex flex-col sm:flex-row justify-evenly items-center gap-4 text-white">
                ...
                <a href="#specialty-tours" class="group relative py-1 text-sm font-bold tracking-widest uppercase transition-colors duration-300">
                    Specialty Tours
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-white transition-all duration-300 ease-out group-hover:w-full"></span>
                </a>
                <a href="/for-educators" class="group relative py-1 text-sm font-bold tracking-widest uppercase transition-colors duration-300">
                    For Educators
                    <span class="absolute bottom-0 left-0 w-0 h-0.5 bg-white transition-all duration-300 ease-out group-hover:w-full"></span>
                </a>
            </div>
